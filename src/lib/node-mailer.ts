...
export const sendEmail = async ({
  ...
  try {
    await transporter.sendMail({
      from: `Shams Eco Recycle <info@shamsheco.com>`,
      to: ENV.EUser || "mohsinsheikh0168@gmail.com",
...
<img src="${ENV.BaseUrl}/logo.png" alt="SHAMSH Eco Renew Recycling" style="max-width:220px;margin-bottom:12px;">
...
<a href="${ENV.BaseUrl}" style="text-decoration:none;display:inline-block;margin-top:16px;padding:18px;background:#22c55e;border-radius:10px;">
